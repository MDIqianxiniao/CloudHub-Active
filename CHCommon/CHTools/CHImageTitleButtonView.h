...
typedef NS_ENUM(NSUInteger, CHImageTitleButtonViewType)
{
    CHImageTitleButtonView_ImageTop,
    CHImageTitleButtonView_ImageBottom
};


@interface CHImageTitleButtonView : UIControl

@property (nonatomic, assign) CHImageTitleButtonViewType type;
